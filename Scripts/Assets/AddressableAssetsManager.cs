...
namespace UniT.ResourceManagement
{
    ...
    public sealed class AddressableAssetsManager : IAssetsManager, IRemoteAssetsDownloader
    {
        ...
        async UniTask<IReadOnlyCollection<T>> IAssetsManager.LoadAllAsync<T>(object key, IProgress<float>? progress, CancellationToken cancellationToken)
        {
        ...
        static AddressableAssetsManager()
        {
